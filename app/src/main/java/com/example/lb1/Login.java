...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static Register RegFrament;
    int attempts = 0;
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "test:testpassword123%", "user:userone123%"
    };
    /**
    ...
    private Intent ChangeToHome = new Intent(getApplicationContext(),MainActivity.class);
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(mUsernameView, R.string.permission_rationale_email, Snackbar.LENGTH_INDEFINITE)
    ...
    private void attemptLogin() {
        ...
        if(attempts >= MAX_LOGIN_ATTEMPTS){
            mUsernameView.setError(getString(R.string.login_error_max_attempts));
            finish();
            System.exit(0);
        }
        ...
        if (cancel) {
            ...
            firebaseAuth.signInWithCustomToken(Login.toString());
